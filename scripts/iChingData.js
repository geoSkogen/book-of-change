...
"In absoulute tranquility, look within--" + "<br/>" +
    "Find chaos in order, and darkness in light." + "<br/>" +
    "Only within Ying can Yang conceive." + "<br/>" +
    "Accept and allow perfection.",

"Only in complete darkness does Yang ignite to bring forth life." + "<br/>" +
    "Beginnings are obscured by uncertainty and chaos." + "<br/>" +
    "Life-creating beauty expressed from the heart brings light and order.",

"Integration brings integrity" + "<br/>" +
    "Empathize with conflicting feelings." + "<br/>" +
    "Feelings are neither good nor bad." + "<br/>" +
    "Like children, they must be equally nurtured.",

"The journey through inner space begins." + "<br/>" +
    "Listen to the master guide." + "<br/>" +
    "Knowledge of the master and attunement to guidance" + "<br/>" +
    "is accessible through stillness.",

"Stand still in the center of the pool." + "<br/>" +
    "As the ripples smooth, the waters become a mirror," + "<br/>" +
    "reflecting all that is heaven.",

"Let go of the ego." + "<br/>" +
    "Released, it leads to the center.",

"Rediscover potential and gather strength" + "<br/>" +
    "by welcoming to the inner circle" + "<br/>" +
    "the most neglected vagrant and the alien.",

"Weave the dark and the light into the whole." + "<br/>" +
    "Weave together emotion and intellect" + "<br/>" +
    "into a state of atonement.",

"Turn inward to the purest, most elementary principles." + "<br/>" +
    "The moment is pregnant.  Do not press for breakthrough." + "<br/>" +
    "Find solace in anticipation and accept chaos to dispel confusion.",

"Be clear. Inspiration is at the full." + "<br/>" +
    "A life moving in love toward enlightenment reflects as a mirror." + "<br/>" +
    "Self-worth and growth provide the images.",

"Be detached from the world of time." + "<br/>" +
    "Be totally in the moment." + "<br/>" +
    "To be there for a moment is to be there forever.",

"Stagnation and breakthrough are two sides of the same hill." + "<br/>" +
    "Traverse the one and surely reach the other." + "<br/>" +
    "Or, stand still while internal resources develop.",

"Follow the clear voice at the center." + "<br/>" +
    "The misleading chatter gives way" + "<br/>" +
    "to harmonious alignment.",

"The secret ingredient is self-compassion.",

"Beauty and fulfillment harmonize" + "<br/>" +
    "with the soul's hidden intent. " + "<br/>" +
    "Seek in innocence in the between.",

"Past and future are reflections of the universal rhythm." + "<br/>" +
    "Dance to the music of the cosmos, the music of the heart.",

"Quiet repose allows inspiration." + "<br/>" +
    "Plumb the core and drink from the deepest well.",

"Every beginning requires first an ending." + "<br/>" +
    "Every ending is followed by a beginning." + "<br/>" +
    "Go to the wellspring.",

"Power is only a vehicle." + "<br/>" +
    "Give full rein to enthusiasm and dreams.",

"While change occurs, keep centered." + "<br/>" +
    "While centered, move freely; ride the wind.",

"Take inventory." + "<br/>" +
    "Accept self-examination without compromise.",

"Contemplate the beauty of the changes unfolding on the horizon." + "<br/>" +
    "Enjoy the grace that is the dance. Enjoy the pattern of the design.",

"Change is inevitable." + "<br/>" +
    "Plough under the old and nourish the new." + "<br/>" +
    "Find strength in quietness and confidence.",

"There is a turning in the darkest night" + "<br/>" +
    "when daylight begins its approach." + "<br/>" +
    "There is a moment in the deepest winter" + "<br/>" +
    "when the face turns toward spring." + "<br/>" +
    "The cycles of nature are the rhythms of life.",

"Satisfy the hunger." + "<br/>" +
    "Make well the wounds." + "<br/>" +
    "Honor the emotion." + "<br/>" +
    "Nurture the vitality." + "<br/>" +
    "Indulge in exuberance." + "<br/>" +
    "Rest in the void.",

"Spiritual wealth is gathered by sharing." + "<br/>" +
    "Respond to each subtle nuance.",

"Sow and cultivate productive, positive thought habits." + "<br/>" +
    "Weed out the rest.",

"Self-control comes out of freed-up emotion." + "<br/>" +
    "Give in." + "<br/>" +
    "Find solace in the void" + "<br/>" +
    "where there is both safety and magic.",

"Truth rewards clear vision and consistent intent." + "<br/>" +
    "Take heart." + "<br/>" +
    "Find courage.",

"When energy is high, work." + "<br/>" +
    "When low, rest." + "<br/>" +
    "Treasure the charred remains." + "<br/>" +
    "Recycle to sustain the eternal flame.",

"Reciprocity rules and chemsitry reigns, from the infinite to the infinitesimal.",

"Move with the changeless.",

"'Healing' is the name of the cosmic magnetism." + "<br/>" +
    "Great energy comes from repulsion as well as attraction." + "<br/>" +
    "The waning moon is the most powerful." + "<br/>" +
    "Bathe in its light.",

"Acknowledge the gains of empowerment." + "<br/>" +
    "Know the meaning that affects the whole," + "<br/>" +
    "the dark as well as the light.",

"Sharpen vision." + "<br/>" +
    "Tame the wild." + "<br/>" +
    "Befriend the frightened." + "<br/>" +
    "Discover new allies" + "<br/>" +
    "and break new ground" + "<br/>" +
    "during this time of growth.",

"The fiery truth shines eternally in the heart." + "<br/>" +
    "Hold it.",

"Purity of purpose is built upon self-respect and genuine affection for the self.",

"There can be no synchronicity without diversity, no integrity without variety." + "<br/>" +
    "Retain all that is natural and celebrate the opposites." + "<br/>" +
    "To the enlightened, opposites are experienced as one.",

"Retreat to the center; examine inhibitions and reactions." + "<br/>" +
    "Acceptance, peace and confidence await discovery.",

"Do not linger in mire." + "<br/>" +
    "Turn the page." + "<br/>" +
    "Let go." + "<br/>" +
    "Hold the hand from above.",

"When the barriers are down," + "<br/>" +
    "the clutter cleared and the clamor silenced," + "<br/>" +
    "there remains the divine essence, the sacred self.",

"Personal empowerment is enhanced through truth and loyalty to the self." + "<br/>" +
    "The universe is agreeable.",

"Principle is compatible with personal growth." + "<br/>" +
    "Apply it." + "<br/>" +
    "Gently but resolutely shine the light" + "<br/>" +
    "down the channel to the inner core.",

"Draw no conclusions." + "<br/>" +
    "Recognize human nature." + "<br/>" +
    "Rest in this wisdom.",

"Look inward from all sides." + "<br/>" +
    "Give the center devotion and commitment.",


"Liberate creativity." + "<br/>" +
    "A meditative balance frees the imagination." + "<br/>" +
    "The freeing of creativity is always a beginning.",

"Through sacrifice, the soul finds its own." + "<br/>" +
    "Truth and strength are carved from silence.",

"The secret hides in insight, self-compassion, and self-nurturing.",

"New meaning will emerge on its own." + "<br/>" +
    "Time now to recognize and honor the seasons of the soul.",


"Energy and inspiration issue from clarity and harmony." + "<br/>" +
    "Know the beauty of the universe." + "<br/>" +
    "Be one with it.",

"Turn within and face the roaring chasm." + "<br/>" +
    "In the maelstrom, find destiny" + "<br/>" +
    "and in the demons, angels.",

"Be open, silent and receptive." + "<br/>" +
    "Cleanse the soul with the music of the spheres.",

"Development is destined to unfold." + "<br/>" +
    "The direction is toward growth." + "<br/>" +
    "Rest in this knowledge.",

"It isn't time to strive toward a goal." + "<br/>" +
    "It isn't the time to advance." + "<br/>" +
    "It is time to be one with the dark.",

"Understand the natural flux between hight and low," + "<br/>" +
    "between fullness and emptiness," + "<br/>" +
    "and free the soul.",

"The butterfly's course is the weaving of a sublime tapestry." + "<br/>" +
    "Graceful intuition acknowledges this moment as passing.",

"Severity requires gentleness." + "<br/>" +
    "There is power in stillness, magic in mercy.",

"Strength and gentleness replenish each other." + "<br/>" +
    "Commitment restores the heart.",

"Renew faith in the healing process." + "<br/>" +
    "Value the infinite soul." + "<br/>" +
    "Give up self-devaluation." + "<br/>" +
    "Self-forgiveness is prerequisite.",

"Align with natural law." + "<br/>" +
    "Survey the inner landscape." + "<br/>" +
    "Scan the horizon, explore the caves, scale the peaks," + "<br/>" +
    "walk in the woods, drink from the springs." + "<br/>" +
    "Nature and human nature and not so far apart.",

"Replace self-doubt and self-judgment with understanding and empathy." + "<br/>" +
    "Compassion for the self lights that which is concealed in the dark.",

"Favor is available only from within.",

"The waters of eternity quell the fires of emotion." + "<br/>" +
    "Even the lonely ache in time becomes a hallowed shelter.",
...
"The open lines suggest the birth canal." + "<br/>" +
    "Yin attracts, receives, and embodies energy transmitted from Yang." + "<br/>" +
    "The mercy of Yang is conceived in Yin's awesome severity." + "<br/>" +
    "Accept the perfect Yang.",

"Consciousness is conceived in love." + "<br/>" +
    "Yang eruption quickens the Yin egg, ignites the Yin lamp." + "<br/>" +
    "Mercifully erupt, mercifully transmit the light.",

"There is something new and exciting going on--" + "<br/>" +
    "a birthright and a destiny, too grand and far-reaching to keep a secret." + "<br/>" +
    "Carefully seek out and nurture associations with sympathetic others.",

"Seek guidance." + "<br/>" +
    "The knowledge comes through awareness." + "<br/>" +
    "While seeking the wisdom of mastery, retain an endearing simplicity " + "<br/>" +
    "and the masterful innocence of youth.",

"Desire is caught in the realm of change." + "<br/>" +
    "Do not be caught by desire." + "<br/>" +
    "Observe without illusion, aware of talents and shortcomings." + "<br/>" +
    "Be still in the eye of the storm.",

"Impeccability does not guarantee freedom from conflict." + "<br/>" +
    "A pause could prevent disaster." + "<br/>" +
    "Consider all viewpoints, then with grace and compassion" + "<br/>" +
    "take the middle path.",

"With a noble vision, a strong collective force can be gathered." + "<br/>" +
    "It will restore balance.",

"Take the opportunity for bonding." + "<br/>" +
    "Be immersed in it." + "<br/>" +
    "Only through joining at heart level with others can purpose be fulfilled." + "<br/>" +
    "For more information, throw the coins again.",

"Now is the time for reticence." + "<br/>" +
    "Wisdom does not strive to influence what cannot be controlled." + "<br/>" +
    "Welcome the constraint as the world welcomes clouds that bring cleansing rain.",

"Honor meekness and mildness." + "<br/>" +
    "Pay strict attention to manners." + "<br/>" +
    "Discriminate between the wholesome and the unwholesome," + "<br/>" +
    "but remember: all are equal.",

"Happiness, peace, good fortune, and success cannot be torn asunder." + "<br/>" +
    "There is help all around." + "<br/>" +
    "Heaven and Earth are in harmony.",

"The inner and outer worlds harmonize though they seem far apart." + "<br/>" +
    "Take heart; have courage." + "<br/>" +
    "Be steadfast." + "<br/>" +
    "Rely upon existing resources.",

"Stay attuned to a certain underlying order regardless of others lack of attunement." + "<br/>" +
    "A clear vision, shared, serves the needs of teh community.",

"Material wealth cannot be put inside." + "<br/>" +
    "Spiritual wealth must accrue from within." + "<br/>" +
    "Faithfulness to the middle path brings abundance.",

"The harmony of the universe resonates in the deepest levels of the psyche." + "<br/>" +
    "Respond from the heart, with spontanaeity." + "<br/>" +
    "Honor the fragility of evolution.",

"Resonance with the cosmic order brings well-being." + "<br/>" +
    "Move with the music played by the Queen of time and space," + "<br/>" +
    "the Triple Goddess--past, present, and future.",

"Enter with discernment into the principles of others, led by love and compassion." + "<br/>" +
    "Being in accord with existing forces dissipates resistance and stress." + "<br/>" +
    "Quiet repose allows inspiration and wise action.",

"Remove the decay." + "<br/>" +
    "Act with compassion but without compromise." + "<br/>" +
    "Choose the course by plumbing highest principles.",

"A time of rapid quickening ensues." + "<br/>" +
    "Use the power as a vehicle, with humble attention to its effect on others." + "<br/>" +
    "All bursts of power soon settle into a new routine.",

"Cultivate grace." + "<br/>" +
    "In motion remain still." + "<br/>" +
    "Reflect upon the paradox.",

"Uncompromising reform serves justice." + "<br/>" +
    "With clarity and energetic intent," + "<br/>" +
    "correct the errors, remove the defects," + "<br/>" +
    "abolish abuse, malpractice, or immoral pursuits.",

"Contemplate the perfection in the moment" + "<br/>" +
    "with clarity of mind, purity of heart, and tranquility of soul." + "<br/>" +
    "Being is beauty and grace.",

"Let go and wait." + "<br/>" +
    "Change is on the way." + "<br/>" +
    "Be the eye of the storm." + "<br/>" +
    "Or be the mountain resting upon the earth." + "<br/>" +
    "Nourish the seeds of growth found within the stress.",

"In the deepest and darkest moment await the light." + "<br/>" +
    "The cycles after a dormant time bring new growth." + "<br/>" +
    "Breathe in the sweetness of anticipation." + "<br/>" +
    "Cultivate the spirit.",

"There is a spontaneity that wilts at the first sign of attention." + "<br/>" +
    "The presence of innocence cannot be cultivated." + "<br/>" +
    "Attend the moment free of expectations, goals, judgments.",

"Enter fully into the mundane and the common during this favorable time." + "<br/>" +
    "Human nature is hungry for the truth and open to growth." + "<br/>" +
    "Contain and wisely dispense enthusiasm.",

"Be aware of food sources and the processes in its preparation." + "<br/>" +
    "Cultivate the awareness of words expressed and their power to nurture or to destroy.",

"A solitary position defines essential being." + "<br/>" +
    "Stand firmly."  + "<br/>" +
    "The ground beneath is solid." + "<br/>" +
    "Potentiality electrifies the environment.",

"Danger brings awareness along with warning." + "<br/>" +
    "Do not lose heart." + "<br/>" +
    "Do not avoid confrontation." + "<br/>" +
    "Act with integrity and courage.",

"Look to others who fuel the fire and sustain its light and warmth." + "<br/>" +
    "Discipline, mutual support and teamwork" + "<br/>" +
    "expand effectiveness, alleviate pressure, and diminish stress.",

"Mutual attraction is at work." + "<br/>" +
    "Speak and act for those who cannot do for themselves," + "<br/>" +
    "or for the cause which is powerless to do so for itself." + "<br/>" +
    "The sun's rays must remain within a narrow constant.",

"Trust instinct." + "<br/>" +
    "Carry on with purposeful endurance." + "<br/>" +
    "In the changing themes of life there is an underlying pattern." + "<br/>" +
    "Identify it to find meaning.",

"Enter fully into the detour and find essentials for the journey." + "<br/>" +
    "If the quest were fulfilled from the beginning, what would be the purpose?" + "<br/>" +
    "Take time to rest and heal.",

"Empowerment brings with it recognition and responsibility," + "<br/>" +
    "the power to nurture or destroy." + "<br/>" +
    "Give clean, clear signals." + "<br/>" +
    "Speak with conviction and compassion.",

"Let go of inferior impulses." + "<br/>" +
    "Diversity produces complementarity." + "<br/>" +
    "Recognize the importance of alliances that further progress." + "<br/>" +
    "Significant tasks can be accomplished.",

"The light, though veiled, is not extenguished." + "<br/>" +
    "Bow to circumstances that oppose deepest principle, yet do not abandon conviction." + "<br/>" +
    "Understand the paradoxical nature of the position and find meaning between the polarities.",

"Act in consideration for the human family." + "<br/>" +
    "Let purity of purpose flower." + "<br/>" +
    "Remember the ancient greeting, 'I am Another Yourself.'" + "<br/>" +
    "Let it transform thought and word.",

"The world is spun between polar oppostites." + "<br/>" +
    "Through compromise, individuals create symphonies." + "<br/>" +
    "Retain individuality while appreciating differences.",

"The trouble comes from burdensome illusions." + "<br/>" +
    "Recognize this and seek counsel." + "<br/>" +
    "Set aside preconceptions, inhibitions, and expectations." + "<br/>" +
    "Self-awareness builds character.",

"When the door opens from the outside, it is time to go." + "<br/>" +
    "Do not call attention to oppressors." + "<br/>" +
    "Maintain terms of friendship but, by all means, go through the door.",

"When ornamentation is removed and excess trimmed away," + "<br/>" +
    "all the remains is the sacred essence of being." + "<br/>" +
    "It is the holy of holies. Nothing else is essential.",

"Benevolent forces are present." + "<br/>" +
    "Use the energy to benefit self and others." + "<br/>" +
    "Give as called for by the most mundane need.",

"Throw off oppression resolutely, without violence." + "<br/>" +
    "Be open, enlisting help if needed." + "<br/>" +
    "Choose carefully the means and the method, remaining true to principle.",

"Dependence reaches balance through autonomy, independence through interdependence." + "<br/>" +
    "Do not confront stronger forces." + "<br/>" +
    "It is not time to establish a new partnership.",

"Bond together with others around the center." + "<br/>" +
    "Look to this person, purpose, or principle, and give it full devotion and strength.",

"Take advantage of opportunity." + "<br/>" +
    "Assertive actions are effective." + "<br/>" +
    "Devotion increases personal power and self-esteem," + "<br/>" +
    "but do not be intimidated by positions of power.",

"When sacrificed, the enduring essence of the self is not lost but furthered." + "<br/>" +
    "Grow strong through adversity." + "<br/>" +
    "In silence the truth becomes evident.",

"Bear in mind the sacredness of human nature." + "<br/>" +
    "Treasure the sameness and uniqueness in others" + "<br/>" +
    "by keeping in touch with the heartbeat within." + "<br/>" +
    "Stimulate individuality." + "<br/>" +
    "There is divinity in every breath.",

"Change overcomes so that meaning is obscured." + "<br/>" +
    "Move with the changes; be one with them." + "<br/>" +
    "Discard what is obsolete." + "<br/>" +
    "New paradigms will emerge on their own.",

"Value the whim of fate." + "<br/>" +
    "Balance between matter and spirit is the key to prosperity;" + "<br/>" +
    "between desire and desirelessness the key to contentment.",

"Shock penetrates defenses and illuminates denial." + "<br/>" +
    "Know the fear, the terror, all the hidden feelings." + "<br/>" +
    "In the knowledge lies great strength.",

"Practice stillness." + "<br/>" +
    "The body mirrors the soul as the lake mirrors the mountain.",

"Don't push." + "<br/>" +
    "Don't resist." + "<br/>" +
    "Open to the process of letting go," + "<br/>" +
    "as a flower opens to the light," + "<br/>" +
    "surrendering to the unfoldment of its own beauty.",

"Play well the subordinate role." + "<br/>" +
    "There is honor in submission but do not give away the vision.",

"Stop, look away from the path and drink-in the view." + "<br/>" +
    "Having achieved the height, prepare for the decline." + "<br/>" +
    "Appreciate the gift of a momentary vista.",

"The traveler weaves a wide web and remains without tangible roots." + "<br/>" +
    "Search leads to discovery, and discovery to a new quest." + "<br/>" +
    "Avoid being a moving target through propriety, grace, and reserve.",

"Be invisible; there is magic afoot." + "<br/>" +
    "The movement of the spirit is sufficient." + "<br/>" +
    "Willing submission brings a special kind of power." + "<br/>" +
    "Establish a goal but bring to bear an unspoken trust in what is already known.",

"The wise join in harmony and understanding." + "<br/>" +
    "Encouragement instills courage, promotes gentleness and camaraderie." + "<br/>" +
    "Empathy with truthfulness releases health and contentment.",

"Go within and direct energy toward healing." + "<br/>" +
    "Transcend that which has led to division and alienation." + "<br/>" +
    "Choose spiritual oneness over egoistic identity.",

"Discover and explore new boundaries." + "<br/>" +
    "Carve from unlimited potential a clearly defined course." + "<br/>" +
    "Choose specific, realizable objectives." + "<br/>" +
    "Be selective.",

"Understand the human condition." + "<br/>" +
    "Apply intuition." + "<br/>" +
    "Observe experience." + "<br/>" +
    "Be confident and sincere, and enjoy.",

"Remember the beginning." + "<br/>" +
    "Seek and find the taproot." + "<br/>" +
    "Act cautiously, conservatively, and conscientiously." + "<br/>" +
    "Timing is all, and favor arrives at its own behest.",

"A goodbye holds the miracle of a tear and a smile in the same moment." + "<br/>" +
    "Take care on the decline, knowing that loss occurs only in form, only in time." + "<br/>" +
    "Perfection rides the crest of every moment.",

"Chaos to order has not yet been achieved." + "<br/>" +
    "Mind the moment of maturation." + "<br/>" +
    "Attend closure and follow-through.",
...
var movingStillLinesOuter = [ /*opens array!--with sub-arrays*/
      /*0*/   ["error0","error1","error2","error3","error4","error5","error6"],
